...
class TestSocialAuth2(APITestCase, BaseFacebookAPITestCase):
    ...
    def test_login_social_jwt_pair_only(self):
    ...
    def test_login_social_jwt_pair_only_provider_in_url(self):
        self._check_login_social_jwt_only(
    ...
    def test_login_social_jwt_pair_user(self):
    ...
    def test_login_social_jwt_pair_user_provider_in_url(self):
        self._check_login_social_jwt_user(
    ...
    def test_login_social_jwt_sliding_only(self):
        self._check_login_social_jwt_only(
    ...
    def test_login_social_jwt_sliding_only_provider_in_url(self):
        self._check_login_social_jwt_only(
    ...
    def test_login_social_jwt_sliding_user(self):
        self._check_login_social_jwt_user(
    ...
    def test_login_social_jwt_sliding_user_provider_in_url(self):
        self._check_login_social_jwt_user(
    ...
    def test_deprecated_login_social_jwt_only(self):
        self._deprecated_check_login_social_jwt_only(
            reverse('login_social_jwt'),
            data={'provider': 'facebook', 'code': '3D52VoM1uiw94a1ETnGvYlCw'})

    def test_deprecated_login_social_jwt_only_provider_in_url(self):
        self._deprecated_check_login_social_jwt_only(
            reverse('login_social_jwt', kwargs={'provider': 'facebook'}),
            data={'code': '3D52VoM1uiw94a1ETnGvYlCw'})

    def test_deprecated_login_social_jwt_user(self):
        self._deprecated_check_login_social_jwt_user(
            reverse('login_social_jwt_user'),
            data={'provider': 'facebook', 'code': '3D52VoM1uiw94a1ETnGvYlCw'})

    def test_deprecated_login_social_jwt_user_provider_in_url(self):
        self._deprecated_check_login_social_jwt_user(
